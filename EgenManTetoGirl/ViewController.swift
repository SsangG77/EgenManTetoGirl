...
struct ResultDescriptions {
    static func description(for result: String) -> String {
        switch result {
        case "테토남":
            return "너는 주도적이고 목표 지향적인 성격을 가진 사람으로, 감정보다는 행동과 논리를 중시하며 강한 존재감으로 주변을 이끄는 유형이야."
        case "에겐남":
            return "너는 감수성 풍부하고 섬세한 공감 능력을 가진 유형으로, 내면의 감정과 정서를 중요하게 여기며 사람과의 유대를 중시해."
        case "테토녀":
            return "너는 독립적이고 활기찬 성격을 가진 사람으로, 도전과 성취를 추구하며 행동으로 자신의 삶을 주도해가는 유형이야."
        case "에겐녀":
            return "너는 따뜻하고 부드러운 감성의 소유자로, 감정과 공감을 중시하고 타인과의 정서적 연결을 통해 안정감을 느끼는 사람이야."
        default:
